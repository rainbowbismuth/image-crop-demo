...
function draw_entropy_cropped(img) {
    ...
    resultCtx.drawImage(img, (cropping_ctl.x * ratio) | 0, (cropping_ctl.y * ratio) | 0, (cropping_ctl.width * ratio) | 0, (cropping_ctl.height * ratio) | 0, 0, 0, result.width, result.height);
